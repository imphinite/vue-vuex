export default {
    ...
    categories: [
        ...
        },
        {
            name: 'Add-On',
            description:
                'Cart and checkout layer to enable sales on existing sites. Includes back-office',
            tags: [1, 2, 3],
            color: '#2a9d8f',
        },
        {
    ...
    entries: [
        {
            name: 'Shopify',
            description: 'Making commerce better for everyone - remotely',
            cat: [0, 3],
        },
        {
            name: 'BigCommerce',
            description:
                'The Open SaaS ecommerce platform that lets you grow your business, your way',
            cat: [0, 3],
        },
        {
            name: 'Magento',
        ...
        },
        {
            name: 'Gumroad',
            description:
                'Super-simple ecommerce for creators and artists, so they can do more of what they love',
            cat: [1],
        },
        {
            name: 'Foxy',
        ...
        },
        {
            name: 'Shogun',
            description:
                'Transform your storefront into a sub-second shopping experience with Shogun Frontend using PWA technology and an end-to-end headless commerce solution',
            cat: [2],
        },
        {
            name: 'Vue Storefront',
        ...
        },
        {
            name: 'Front-Commerce',
            description:
                'Build delightful eCommerce shops with the technologies of 2020 without the hassle of keeping them up-to-date!',
            cat: [2],
        },
        {
            name: 'Commerce.js',
            description:
                'Headless, API-first eCommerce platform for experiential commerce. Join our Slack channel',
            cat: [3],
        },
        {
            name: 'Commerce Layer',
        ...
        },
        {
            name: 'Nacelle',
            description:
                'The framework for building lightning-fast storefronts using Headless Progressive Web App technology',
            cat: [3],
        },
    ],
}
